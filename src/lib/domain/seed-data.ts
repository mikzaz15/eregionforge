...
export const seedTheses: Thesis[] = [
  {
    ...
    supportBySection: {
      summary: {
        ...
        entityIds: ["entity-ns-company", "entity-ns-gross-margin", "entity-ns-pricing-pressure"],
      ...
      bearCase: {
        ...
        entityIds: ["entity-ns-pricing-pressure", "entity-ns-market-vendors"],
      ...
      keyRisks: {
        ...
        entityIds: ["entity-ns-pricing-pressure", "entity-ns-gross-margin"],
      ...
      keyUnknowns: {
        ...
        entityIds: ["entity-ns-pricing-pressure", "entity-ns-company"],
        catalystIds: ["catalyst-ns-q1-results"],
      ...
      catalystSummary: {
        ...
        entityIds: ["entity-ns-gen4-platform", "entity-ns-pricing-pressure"],
        catalystIds: [
          "catalyst-ns-q1-results",
          "catalyst-ns-gen4-ramp",
          "catalyst-ns-asp-watch",
        ],
        timelineEventIds: [
          "event-ns-q1-results",
          "event-ns-gen4-ramp",
...
export const seedThesisRevisions: ThesisRevision[] = [
  {
    ...
    supportBySection: {
      ...
      bearCase: {
        ...
        sourceIds: ["source-ns-earnings-call"],
        entityIds: ["entity-ns-company", "entity-ns-gross-margin"],
        catalystIds: ["catalyst-ns-q1-results"],
      ...
      keyRisks: {
        ...
        claimIds: ["claim-ns-margin-delay"],
        sourceIds: ["source-ns-earnings-call"],
        entityIds: ["entity-ns-gross-margin"],
        catalystIds: ["catalyst-ns-q1-results"],
        timelineEventIds: ["event-ns-q4-results"],
        contradictionIds: [],
      },
      keyUnknowns: {
        ...
        claimIds: ["claim-ns-price-durability-open"],
        sourceIds: ["source-ns-channel-checks"],
        entityIds: ["entity-ns-pricing-pressure"],
        catalystIds: [],
        timelineEventIds: ["event-ns-q1-results"],
        contradictionIds: [],
      },
      catalystSummary: {
        ...
        entityIds: ["entity-ns-gen4-platform", "entity-ns-management"],
